...
import ba.unsa.pmf.math.covid_19vaccinationapp.fragments.list.ListFragmentDirections as ListFragmentDirections1
...
class ListAdapter:RecyclerView.Adapter<ListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.datum2.text=currentItem.date.toString()
